...
// Example usage with a complex React component type
import { View, Animated } from "react-native";
import { ButtonProps } from "react-native-paper";

type WithClassNameProps<T> = {
  className?: T;
};

type ComplexButtonProps = Omit<ButtonProps, "ref"> &
...
const Button: React.ComponentType<ComplexButtonProps> = () => null; // Dummy implementation

type ExtractedButtonProps = ReactComponentProps<typeof Button>;
